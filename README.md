...
-En este ejercicio he solicitado que ingrese un número y a través de un aestructura de if e if else, que sigue una condición para resover el ejercicio, el programa diferencia entre un impar, un 0 y un par

Ejercicio 2: Día de la Semana
Crea un programa en C++ que solicite al usuario ingresar un número del 1 al 7. El programa deberá imprimir el nombre del día de la semana correspondiente al número ingresado (por ejemplo, 1 para lunes, 2 para martes, ..., 7 para domingo). 

-Este ejrcicio se resuelve a través de un conjunto de condiciones, el switch. Simplemente hay que hacer un "case" por cada número de la semana y un default para que el programa detecte un número que no sea del 1 al 7

Ejercicio 3: Cálculo de Promedio de Calificaciones
Un estudiante ha completado un curso de programación avanzada en C++. Durante el curso, ha realizado 8 ejercicios prácticos, y cada ejercicio se califica con una nota entre 0 y 10. Escribe un programa que solicite al usuario introducir las calificaciones obtenidas por el estudiante en cada uno de los 8 ejercicios. El programa deberá calcular y mostrar el promedio de las calificaciones. 

Este codigo declara un array de tamaño n. Seguido de un bucle for que recorre el array y otro que lo rellena. Solo queda imprimir el promedio y el total y poner delete[]p, para liberar la memoria almacenada en el array.
